...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#fdfcf8] pb-24">
      ...
      {/* --- TOP PERSISTENT CTA BANNER --- */}
      {/* Adjusted z-index and top value to stack correctly with Navbar */}
      ...
      <section className="relative min-h-[600px] md:h-[85vh] w-full flex items-center justify-center overflow-hidden py-20 lg:py-0">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <Link 
              href="/coffee" 
              className="w-full sm:w-auto bg-[#f4f1ea] text-[#2c2926] px-10 py-4 text-[10px] uppercase tracking-widest font-bold hover:bg-[#8b5e3c] hover:text-[#f4f1ea] transition-all duration-300 shadow-2xl"
            >
              Order Coffee
            </Link>
            <Link 
              href="/library" 
              className="w-full sm:w-auto border border-[#f4f1ea] text-[#f4f1ea] px-10 py-4 text-[10px] uppercase tracking-widest font-bold hover:bg-[#f4f1ea] hover:text-[#2c2926] transition-all duration-300"
            >
              Browse Books
            </Link>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 space-y-32">
        ...
        <section className="grid md:grid-cols-2 bg-[#1e3932] text-white overflow-hidden rounded-sm shadow-xl">
          ...
          <div className="flex flex-col justify-center items-center text-center p-8 md:p-20 space-y-6">
            <h2 className="text-3xl md:text-5xl font-serif font-bold leading-tight">Vanilla Oak is here</h2>
        ...
        <section className="relative grid md:grid-cols-2 bg-[#f4f1ea] border border-[#dcd7cc] rounded-sm overflow-hidden">
          <div className="p-8 md:p-20 flex flex-col justify-center space-y-6">
          ...
          <div className="bg-[#8b5e3c]/10 flex items-center justify-center p-8 md:p-12">
            <div className="w-56 md:w-64 h-72 md:h-80 bg-white shadow-2xl rotate-3 flex flex-col p-6 border border-[#dcd7cc] relative">
              <div className="w-full h-32 md:h-40 bg-[#f4f1ea] mb-4" />
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center bg-[#fdfcf8] py-12">
          ...
          <div className="order-1 md:order-2 p-6 md:p-8 md:pl-16 space-y-6 text-left">
        ...
        <section className="bg-[#2c2926] text-[#f4f1ea] rounded-sm overflow-hidden flex flex-col md:flex-row shadow-2xl">
          ...
          <div className="md:w-2/3 p-8 md:p-20 flex flex-col justify-center text-left">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold leading-tight mb-6">The Listening Corner.</h2>
            <p className="text-stone-400 font-sans text-sm md:text-base leading-relaxed max-w-xl mb-8">
